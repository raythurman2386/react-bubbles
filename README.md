...
> A token is mainly going to be used for authentication in a front end application.

- [x] What steps can you take in your web apps to keep your data secure?

> Ensure that your app requires a login and that it would have protected endpoints that would only be accesible to members that are logged in and have a valid JWT.
